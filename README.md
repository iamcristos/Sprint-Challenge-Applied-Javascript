...
1. What is the DOM?
    ...
    Document Object Model (DOM) is a object representation of the webpage html

2. What is an event?

    event are simply actions by a user on our web pages; these includes click, scroll etc
